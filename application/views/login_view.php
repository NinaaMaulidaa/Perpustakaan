...
<body class="hold-transition login-page" opacity="0.5" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/buku7.jpg');?>')no-repeat;background-size:100%;">
<div class="login-box">
	<br/>
  <div class="contaier">
    <center>
    <a href="index.php" style="font-size:25px; color: yellow; ">PERPUSTAKAAN <br/><b>STMIK MARDIRA INDONESIA</b></a>
    </center>
  </div>
  ...
  <center>
  <img src= "assets_style/image/logo.png" width="50" height="50">
  </center>
